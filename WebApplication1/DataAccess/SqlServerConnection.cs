...
public class SqlServerConnection
{
    ...
    private static string connectionString = "Data Source=" + Config.Configuration.SqlServer.Server + "; Initial Catalog=" + Config.Configuration.SqlServer.Database + "; User Id=" + Config.Configuration.SqlServer.User + "; Password=" + Config.Configuration.SqlServer.Password + "; MultipleActiveResultSets=true;";
    #endregion
